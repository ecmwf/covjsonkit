...
class TestDecoder:
    ...
    def test_frame_referencing(self):
        decoder = Frame.Frame(self.covjson)
        assert decoder.get_referencing() == ["x", "y", "z"]

    def test_frame_get_parameter_metadata(self):
        decoder = Frame.Frame(self.covjson)
    ...
    def test_frame_mars_metadata(self):
        decoder = Frame.Frame(self.covjson)
    ...
    def test_frame_get_coordinates(self):
        decoder = Frame.Frame(self.covjson)
        coordinates = {
            "t": {"values": ["2017-01-01T00:00:00"]},
            "composite": {
    ...
    def test_frame_get_values(self):
        decoder = Frame.Frame(self.covjson)
        values = {
            "t": [
