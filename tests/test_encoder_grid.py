...
class TestEncoder:
    ...
    def test_standard_Coverage(self):
        encoder_obj = Covjsonkit().encode("CoverageCollection", "Grid")
        covjson = {"type": "CoverageCollection", "domainType": "Grid", "coverages": []}
    ...
    def test_add_parameter(self):
        ...
        assert len(encoder_obj.covjson["parameters"]) == 2
    ...
    def test_add_reference(self):
        ...
        assert len(encoder_obj.covjson["referencing"]) == 1
