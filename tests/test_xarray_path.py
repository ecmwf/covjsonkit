...
class TestPathXarray:
    ...
    def test_from_xarray(self):
        ...
        # Encoder now emits spec-compliant Trajectory composite: coordinates
        # ["t","x","y","z"] with values ordered [t, lon, lat, level]. The legacy
        # fixture is mislabeled ([t, lat, lon, level]); the decoder reads it
        # back-compatibly, so the round-trip swaps lat/lon into spec order.
        ...
        expected_values = [[t, lon, lat, z] for (t, lat, lon, z) in legacy_values]
